...
def main():
    ...
    parser.add_argument("--video", default="tester/images/TheBigBangTheory.mp4")
    parser.add_argument("--embeddings", default="tester/embeddings.npz")
